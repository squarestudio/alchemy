window.Squarespace.onInitialize(Y, function() {
    ...
    let footerButton = document.querySelector('footer button.form-submit-button');
    ...
    footerButton.addEventListener("mouseleave", () => {
        TweenMax.to("footer button.form-submit-button .morph", 1, {
            ease:Power2.easeInOut, morphSVG:"footer button.form-submit-button .morph", yoyo: false
        });
    });
